...
export default class ProductForm {
    ...
    setFormData(product) {
        ...
        const sortableList = new SortableList({
            items: product.images.map(image => {
                ...
                elem.innerHTML = this.getItemImage(image);
                
                return elem.firstElementChild;
            })
        });
        const listImages = this.subElements.imageListContainer;
        listImages.append(sortableList.element);
    ...
    getFormData() {
        ...
        const listImages = [...this.subElements.imageListContainer.querySelectorAll(".sortable-list li")];
    ...
    fileInputChange = async () => {
        ...
        if (fileUploaded) {
            const listImages = this.subElements.imageListContainer.querySelector(".sortable-list");
